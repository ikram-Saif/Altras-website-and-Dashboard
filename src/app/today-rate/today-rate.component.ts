...
@Component({
  selector: 'app-today-rate',
  templateUrl: './today-rate.component.html',
  styleUrls: ['./today-rate.component.css']
})
export class TodayRateComponent implements OnInit {
  ...
  constructor(
    ...
    fillDeliveryCurencies(){
      ...
      this.deliveryCurencies = this.calculatorRate.find((rates:any) => 
...
// ), 'customer aount')
  ...
  ngOnInit(): void {
    ...
    this.sendCurrency = this.localStorage.getSendingCurrency()
    this.todayRateForm.patchValue({
    receivingCountry :34,
      deliveryMethod:"1",
